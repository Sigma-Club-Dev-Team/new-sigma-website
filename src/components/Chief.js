    ...
    return (
        ...
        <Container maxW='100%' className='animate-bottom' mb={20} px={10}>
            ...
            <Flex direction={{ base: "column", md: "row" }}>
                    <Box flex="4" color="white" py={{ lg: "4", md: '3', sm: '4' }}
                    px={{ lg: "8", md: '3', sm: '4' }}
                    ...
                    <Box flex="6" py={{base: '7', lg: "6", md: '4', sm: '4' }}
                    px={{ lg: "6", md: '2', sm: '1' }}
                    ...
                    <Text
                            ...
                            lineHeight='normal'
                    >
                       He is a 400L student of Music Department, Faculty of Arts. He is a business Enthusiast and a lover of music
                       <br />
